...
const int PawnPSQT[SQUARE_NB] = {
    ...
    S(   5, -22), S(   4, -10), S( -20,  17), S( -17,  18),
    S( -15,  18), S( -18,  11), S( -16,  -8), S(   4, -29),
    S(  -2, -24), S( -18,  -9), S( -23,  13), S( -17,  21),
    S( -20,  48), S(  -9,  44), S(   1,  31), S(  17,  -9),
    S(  35,  -6), S(  -9,  31), S(  -6,  45), S( -23,  49),
    S( -33, -70), S( -65,  -9), S( -16, -22), S(  65, -23),
...
const int KnightPSQT[SQUARE_NB] = {
    ...
    S( -24,  25), S(  -5,  37), S(  25,  56), S(  22,  59),
    S(  27,  55), S(  29,  55), S(  -1,  32), S( -19,  25),
    S(  13,  -2), S( -11,  18), S(  27,  -2), S(  37,  24),
    S(  41,  24), S(  39,  -7), S( -13,  16), S(   2,  -2),
    S(-167,  -5), S( -91,  13), S(-117,  41), S( -38,  17),
    S( -18,  19), S(-105,  48), S(-118,  24), S(-165, -16),
};
...
const int BishopPSQT[SQUARE_NB] = {
    ...
    S( -66,  18), S( -64,  36), S(-122,  48), S(-107,  56),
...
const int RookPSQT[SQUARE_NB] = {
    ...
    S( -33,  59), S(  17,  41), S(   0,  54), S(  33,  36),
...
const int KingPSQT[SQUARE_NB] = {
    ...
    S( -16,-152), S(  49, -94), S( -21, -73), S( -19, -33),
    S( -51, -54), S( -42, -62), S(  53, -93), S( -58,-134),
};
...
const int PawnConnected32[32] = {
    ...
    S(  44,  40), S(  37,  64), S(  58,  74), S(  64,  88),
